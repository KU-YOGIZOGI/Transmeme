...
class Test5ViewController: UIViewController {
    ...
    let quiznumLabel = UILabel().then {
        let fullString = NSMutableAttributedString(string: "Q.5", attributes: [
