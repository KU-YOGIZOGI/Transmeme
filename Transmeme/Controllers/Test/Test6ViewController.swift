...
class Test6ViewController: UIViewController {
    ...
    let hintLabel2 = UILabel().then {
        ...
        let attrString = NSMutableAttributedString(string: "ex. 와 진짜 이게 머선129", attributes: [NSAttributedString.Key.paragraphStyle: paragraphStyle])
        $0.attributedText = attrString
    }
